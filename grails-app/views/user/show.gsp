	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<g:if test="${userInstance?.fechaCreado}">
				<li class="fieldcontain">
					<span id="fechaCreado-label" class="property-label"><g:message code="user.fechaCreado.label" default="Fecha Creado" /></span>
					
						<span class="property-value" aria-labelledby="fechaCreado-label"><g:formatDate date="${userInstance?.fechaCreado}" /></span>
