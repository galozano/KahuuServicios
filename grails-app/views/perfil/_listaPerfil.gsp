...
<div class="post azul">
	<g:link action="profileUsuario" params="[usuario:profileInstance.usuario,ciudad:nombreCiudad]"></g:link>
	<g:if test="${profileInstance?.image}">
		<g:link action="profileUsuario" params="[usuario:profileInstance.usuario,ciudad:nombreCiudad]">
	...
	<div class="title">
		...
		<g:link action="profileUsuario" params="[usuario:profileInstance.usuario,ciudad:nombreCiudad]">${fieldValue(bean: profileInstance, field: "nombre")}</g:link>
